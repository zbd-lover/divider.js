var divider = (function (exports) {
  ...
  var Divider = /*#__PURE__*/function () {
    ...
    _createClass(Divider, [{
      ...
      value: function subscribe(name, tag, fn) {
        ...
        if (typeof tag === "function" && !isUndef(name)) {
          ...
          if (!this.hasTask(name)) {
            throw new Error("\n          Cant't subscribe undefined task named ".concat(name, ".\n        "));
      ...
      value: function dispatch(action) {
        ...
        var taskFn = this.getTaskFn(nextName); // Toggle task's status and run hooks
        ...
        var noifyWrapper = function noifyWrapper() {
  ...
  var _excluded = ["type"];
  function applyBuiltInErrHandler(divider) {
    var log = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : console.log;

    if (typeof (divider === null || divider === void 0 ? void 0 : divider.subscribe) !== 'function') {
      throw new Error("\n      The divider maybe be not generated by createDivider() .\n    ");
    }

    var logs = {};
    divider.subscribe('start', function (_ref) {
      var type = _ref.type,
          rest = _objectWithoutProperties(_ref, _excluded);

      type && (logs[type] = _objectSpread2({}, rest));
    });
    divider.subscribe('end', function () {
      var _ref2 = (arguments.length <= 1 ? undefined : arguments[1]) || {},
          type = _ref2.type;

      type && delete logs[type];
    });
    divider === null || divider === void 0 ? void 0 : divider.setErrorHandler(function (_ref3) {
      var error = _ref3.error,
          action = _ref3.action;

      var rest = _objectSpread2({}, logs);

      action.type && delete rest[action.type];
      log({
        error: error,
        occur: action,
        others: _objectSpread2({}, rest)
      });
    });
  }
  ...
  function createDivider(actionObj, discrete) {
    ...
    return {
      ...
      replaceActionObj: function replaceActionObj(obj) {
        return divider.replaceActionObj(obj);
      },
  ...
  exports.applyBuiltInErrHandler = applyBuiltInErrHandler;
